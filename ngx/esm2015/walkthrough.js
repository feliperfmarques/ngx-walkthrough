...
class WalkthroughComponent {
    constructor() {
        ...
        this.onWalkthroughSkip = new EventEmitter();
...
WalkthroughComponent.propDecorators = {
    ...
    "buttonSkipCaption": [{ type: Input, args: ['button-skipe-caption',] },],
    "useButton": [{ type: Input, args: ['use-button',] },],
    "skipButton": [{ type: Input, args: ['skip-button',] },],
    ...
    "onWalkthroughSkip": [{ type: Output, args: ['on-walkthrough-skip',] },],
